...
class _AuthCardState extends State<AuthCard>
  ...
  void initState() {
    ...
    _heightAnimation = Tween<Size>(
      ...
      end: Size(double.infinity, 310),
    ).animate(CurvedAnimation(parent: _controller, curve: Curves.fastOutSlowIn),);
    super.initState();
    // _heightAnimation.addListener(() => setState(() {}));

    _opacityAnimation = Tween<double>(begin: 0.0, end: 1).animate(CurvedAnimation(parent: _controller , curve: Curves.easeIn));
  }
  ...
  void _submit() async {
    ...
    try {
      ...
      if (error.toString().contains('EMAIL_EXISTS')) {
        ...
        errorMessage = 'This is password is not valid.';
      }
